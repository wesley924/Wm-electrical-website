...
<body><div class="page">
  ...
  <div class="info-grid">
    ...
    <div class="info-row"><div class="info-label">RCDs / RCBOs Present?</div><div class="info-value">${statusOrPlain(data.rcds_rcbos_present, ["no"])}</div></div>
    ${showMainPushButton ? `<div class="info-row"><div class="info-label">Push-Button Test Result</div><div class="info-value">${statusOrPlain(data.pushbutton_test_result, ["fail"])}</div></div>` : ""}
  </div>
  ...
  <div class="info-grid">
    ...
    <div class="info-row"><div class="info-label">RCDs / RCBOs Present?</div><div class="info-value">${statusOrPlain(data.subboard_rcds_rcbos_present, ["no"])}</div></div>
    ${showSubPushButton ? `<div class="info-row"><div class="info-label">Push-Button Test Result</div><div class="info-value">${statusOrPlain(data.subboard_pushbutton_test_result, ["fail"])}</div></div>` : ""}
  </div>` : ""}
